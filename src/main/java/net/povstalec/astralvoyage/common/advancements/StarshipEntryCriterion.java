package net.povstalec.astralvoyage.common.advancements;
...
public class StarshipEntryCriterion extends SimpleCriterionTrigger<StarshipEntryCriterion.StarshipTravelTrigger>
{
	public static final StarshipEntryCriterion INSTANCE = new StarshipEntryCriterion();
	private static final ResourceLocation CRITERION_ID = new ResourceLocation(AstralVoyage.MODID, "starship_entry");
	
	@Override
	protected StarshipTravelTrigger createInstance(JsonObject obj, ContextAwarePredicate playerPredicate, DeserializationContext predicateDeserializer)
	{
		...
		return new StarshipTravelTrigger(playerPredicate, initialDimension, destinationDimension, distanceTraveled);
	}
	...
	public static class StarshipTravelTrigger extends AbstractCriterionTriggerInstance
	{
