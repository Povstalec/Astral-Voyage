...
public class CapabilitiesInit {
    public static final Capability<SpaceshipCapability> SPACESHIP = CapabilityManager.get(new CapabilityToken<>() {});
    public static final Capability<PlanetCapability> PLANET = CapabilityManager.get(new CapabilityToken<>() {});

    @SubscribeEvent
    public static void register(RegisterCapabilitiesEvent event){
        event.register(SpaceshipCapability.class);
        event.register(PlanetCapability.class);
    }
