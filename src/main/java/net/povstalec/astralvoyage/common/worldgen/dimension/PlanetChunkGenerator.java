package net.povstalec.astralvoyage.common.worldgen.dimension;
...
public class PlanetChunkGenerator extends ChunkGenerator {
    ...
    public PlanetChunkGenerator(HolderLookup.RegistryLookup<Biome> biomeReg) {
        super(new FixedBiomeSource(biomeReg.getOrThrow(ResourceKey.create(Registries.BIOME, new ResourceLocation(AstralVoyage.MODID, "planets/lifeless_ocean")))));
    ...
    @Override
    public Codec<PlanetChunkGenerator> codec() {
        return CODEC;
    }
